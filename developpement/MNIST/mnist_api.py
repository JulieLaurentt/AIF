...
parser.add_argument('--model_path', type=str, default = 'weights/mnist_net.pth', help='model path') # définit où sont les poids à charger
...
# Load the model
model.load_state_dict(torch.load(model_path)) # chargement des poids dans le modèl
model.eval()
